...
const ChatInput: FC<ChatInputProps> = ({ chatPartner, chatId }) => {
    ...
    return <div className='border-t border-gray-200 dark:border-slate-700 px-4 pt-4 mb-2 sm:mb-0'>
        <div className='relative flex-1 overflow-hidden rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600  dark:focus-within:ring-slate-700 dark:ring-zinc-400'>
            ...
            <div className='absolute right-0 bottom-0 flex justify-between py-2 pl-3 pr-2'>
                <div className='flex-shrink-0'>
                    <Button onClick={sendMessage} type='submit' isLoading={isLoading} className='dark:hover:bg-slate-300'>Send</Button>
                </div>
            </div>
        </div>
    </div>
