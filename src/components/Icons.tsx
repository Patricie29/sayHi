import { LucideProps, UserPlus, Check } from "lucide-react";

export const Icons = {
    // fifrst option under out Icons prop will be Logo:
    ...
    // second option will be UserPlus icon
    UserPlus,
}


// since we have two options in the Icons - either logo or UserPlus icon with this syntax below it lets you select what option you want to have, either the Logo or the UserPlus when you want to use it 
