...
import UnseenChatToastNotification from './UnseenChatToastNotification'
...
const SidebarChatlist: FC<SidebarChatlistProps> = ({ friends, sessionId }) => {
    ...
    useEffect(() => {
        ...
        const chatHandler = (messageData: ExtendedMessage) => {
            ...
            toast.custom((t) => (
                <UnseenChatToastNotification t={t} sessionId={sessionId} senderId={messageData.senderId} senderImg={messageData.senderImg} senderMessage={messageData.text} senderName={messageData.senderName} />
            ))
